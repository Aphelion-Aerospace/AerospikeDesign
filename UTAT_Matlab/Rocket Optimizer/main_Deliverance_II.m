...
imported = import_params('Engine Preliminary Design Calculations.xlsx', ...
    'Import Data - Deliverance', 1, 25);
...
%             ((gamma+1)/(2*gamma-2)) - e(Ma_cc, gamma), 0.5);    %Exit Mach.
    ...
    C_D(i) = Coefficient_of_Drag_Deliverance(Drag_Model, s(2,i), M, is_burning);          %get coefficient of drag
